...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center text-center px-4 py-16 sm:py-20 relative">
      <div className="max-w-3xl w-full">
        {/* Avatar */}
        <div className="mb-6 sm:mb-8">
          <div className="relative w-[200px] h-[200px] sm:w-[240px] sm:h-[240px] md:w-[280px] md:h-[280px] mx-auto">
        ...
        {/* Terminal Window */}
        <div className="terminal-window text-left mb-6 sm:mb-8">
          <div className="terminal-header">
            ...
            <div className="flex-1 text-center font-mono text-xs sm:text-sm text-[var(--text-muted)]">
              aman@portfolio:~
            </div>
          </div>
          <div className="p-4 sm:p-6 font-mono text-xs sm:text-sm">
            ...
            {showOutput && (
              <div className="pl-4 sm:pl-6 space-y-1 animate-fadeIn">
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <span className="text-cyan-400 sm:min-w-[100px]">name:</span>
                  <span className="text-lg sm:text-xl font-bold gradient-text">{personalInfo.name}</span>
                </div>
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <span className="text-cyan-400 sm:min-w-[100px]">role:</span>
                  <span className="text-[var(--text-secondary)]">{personalInfo.role}</span>
                </div>
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <span className="text-cyan-400 sm:min-w-[100px]">location:</span>
                  <span className="text-[var(--text-secondary)]">{personalInfo.location}</span>
                </div>
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <span className="text-cyan-400 sm:min-w-[100px]">experience:</span>
                  <span className="text-[var(--text-secondary)]">{personalInfo.experience}</span>
                </div>
                <div className="flex flex-col sm:flex-row gap-1 sm:gap-4">
                  <span className="text-cyan-400 sm:min-w-[100px]">focus:</span>
        ...
        {/* Tagline */}
        <p className="text-base sm:text-lg md:text-xl text-[var(--text-secondary)] mb-6 sm:mb-8 leading-relaxed px-2">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center px-4 sm:px-0">
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500 via-cyan-400 to-teal-400 text-white font-medium hover:shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 hover:-translate-y-0.5"
          >
          ...
          <a
            href="#projects"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full border border-[var(--glass-border)] text-[var(--text-primary)] font-medium hover:bg-white/5 hover:border-cyan-500 transition-all duration-300"
          >
            <span>View Work</span>
            <span>↓</span>
          </a>
      ...
      {/* Scroll Indicator */}
      <div className="hidden sm:flex absolute bottom-24 md:bottom-32 left-1/2 -translate-x-1/2 flex-col items-center gap-3 text-[var(--text-muted)] text-xs bounce-animation">
