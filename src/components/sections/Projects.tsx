        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="relative h-48 bg-gradient-to-br from-[var(--bg-tertiary)] to-[var(--bg-secondary)] flex items-center justify-center overflow-hidden">
              <div
                className={`w-20 h-20 flex items-center justify-center rounded-full opacity-30 ${
                  project.award
              ...
              <div className="absolute inset-0 bg-black/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <a
                  ...
                  className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-500 via-cyan-400 to-teal-400 rounded-full text-white font-medium transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300"
                >
                  {project.github ? (
                    <>
